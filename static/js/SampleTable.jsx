...
const columns = [
                    { text: 'SampleID', dataField: 'SampleID', hidden: true }, { text: 'DatasetID', dataField: 'datasetID', hidden: true }, { text: 'Cohort', dataField: 'activeCohort', sort: true, filter: textFilter() }, { text: 'Family code', dataField: 'FamilyID', sort: true, filter: textFilter() }, { text: 'Participant code', dataField: 'Sample', sort: true, filter: textFilter(), formatter: (cell, row) => {return ( <SampleLink sampledetails={row} /> ); } }, { text: 'Dataset type', dataField: 'datasetType', sort: true, filter: textFilter() }, { text: 'Date entered', dataField: 'EnteredDate', sort: true, filter:  textFilter(), }, { text: 'Analysis status', dataField: 'AnalysisStatus', sort: true, filter: textFilter(), formatter: (cell,row) => {return (<AnalysisPopOver sampledetails={row} />);} }, { text: 'Analysis status updated on ', dataField: 'AnalysisDate', sort:true, filter: textFilter() }, { text: 'Solved status', dataField: 'Status', sort: true, filter: textFilter() }, { text: 'Assigned to', dataField: 'AssignedTo', sort: true, filter: textFilter() }, {text: 'Notes', dataField: 'Notes', sort: false, filter: textFilter()}
                ];
